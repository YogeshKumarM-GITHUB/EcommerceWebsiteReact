                ...
                <div className="bg-[#f1f1f1] w-auto h-auto md:w-[400px] md:h-[500px] rounded-md p-5">
                    <div className="flex flex-col mt-2">
                        ...
                        <form onSubmit={LoginOrPassOrSignUp} className="mt-10 p-4 w-full flex flex-col gap-y-10">
                            <input type="email" name="Email" value={user.Email} placeholder="Email" onChange={(e) => setUser({ ...user, Email: e.target.value })} className="outline-none px-4 border-b-2 border-b-gray-400 w-full" />
                            {(buttontext == "Sign Up" || buttontext == "Login") && <input type="password" name="Password" value={user.Password} placeholder="Password" onChange={(e) => setUser({ ...user, Password: e.target.value })} className="outline-none px-4 border-b-2 border-b-gray-400 w-full" />}
                            {(buttontext == "Sign Up") && <input type="password" name="ConfirmPassword" value={user.ConfirmPassword} placeholder="Confirm Password" onChange={(e) => setUser({ ...user, ConfirmPassword: e.target.value })} className="outline-none px-4 border-b-2 border-b-gray-400 w-full" />}
